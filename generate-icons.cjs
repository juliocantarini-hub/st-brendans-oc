...
<svg width="512" height="512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="220" cy="360" r="60" fill="#9FE1CB"/>
  <rect x="270" y="100" width="28" height="280" fill="#9FE1CB" rx="14"/>
  <path d="M298 100 Q420 140 400 230 Q380 300 298 280" fill="#9FE1CB"/>
</svg>
`
